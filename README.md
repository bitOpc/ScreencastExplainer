...
**Cover** (auto-generated by `build_cover.py`):

![Demo cover — Attention / 机制深度解析](docs/assets/demo-cover.png)

**Preview** (24s clip from the composed video: burned-in subtitles, narration audio, and PageDown scroll during the Attention section):

<video src="docs/assets/demo-preview.mp4" controls width="720"></video>

Full version (~10 min): **[Watch on YouTube](https://youtu.be/Es6ZjRlRd_Q)** — opens YouTube in a new tab; GitHub does not embed external YouTube players in README.
